    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <article className="max-w-none text-gray-600">
        ...
        <ul className="space-y-1 mb-8">
          ...
          <li><a href="#stripe-datenschutzerklaerung" className="text-blue-600 hover:underline">Stripe Datenschutzerklärung</a></li>
        </ul>
...
⚖️ Rechtsgrundlagen: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</p>
        ...
        <h2 id="stripe-datenschutzerklaerung" className="mb-4 mt-8 text-xl font-bold text-gray-900">Stripe Datenschutzerklärung</h2>
        <div className="border border-gray-300 rounded p-4 my-4">
          <p className="font-semibold mb-2">Stripe Datenschutzerklärung Zusammenfassung</p>
          <p>👥 Betroffene: Besucher der Website<br/>
🤝 Zweck: Optimierung des Zahlungsvorgangs auf unserer Website<br/>
📓 Verarbeitete Daten: Daten wie etwa Name, Adresse, Bankdaten (Kontonummer, Kreditkartennummer, Passwörter, TANs usw.), IP-Adresse und Vertragsdaten. Mehr Details dazu finden Sie weiter unten in dieser Datenschutzerklärung.<br/>
📅 Speicherdauer: Daten werden gespeichert, bis die Zusammenarbeit mit Stripe aufgelöst wird<br/>
⚖️ Rechtsgrundlagen: Art. 6 Abs. 1 lit. b DSGVO (Vertragsabwicklung), Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)</p>
        </div>
        <h3 className="mb-3 mt-6 text-lg font-semibold text-gray-900">Was ist Stripe?</h3>
        ...
        <h3 className="mb-3 mt-6 text-lg font-semibold text-gray-900">Warum verwenden wir Stripe für unsere Website?</h3>
        ...
        <h3 className="mb-3 mt-6 text-lg font-semibold text-gray-900">Welche Daten werden von Stripe gespeichert?</h3>
        ...
        <p><strong>Name:</strong> m<br/>
<strong>Wert:</strong> edd716e9-d28b-46f7-8a55-e05f1779e84e040456138702885-5<br/>
<strong>Verwendungszweck:</strong> Dieses Cookie erscheint, wenn Sie die Zahlungsmethode auswählen. Es speichert und erkennt, ob Sie über einen PC, ein Tablet oder ein Smartphone auf unsere Website zugreifen.<br/>
<strong>Ablaufdatum:</strong> nach 2 Jahren</p>
        <p><strong>Name:</strong> __stripe_mid<br/>
<strong>Wert:</strong> fc30f52c-b006-4722-af61-a7419a5b8819875de9138702885-1<br/>
<strong>Verwendungszweck:</strong> Um eine Kreditkartentransaktion durchführen zu können, wird dieses Cookie benötigt. Dazu speichert das Cookie Ihre Sitzungs-ID.<br/>
<strong>Ablaufdatum:</strong> nach einem Jahr</p>
        <p><strong>Name:</strong> __stripe_sid<br/>
<strong>Wert:</strong> 6fee719a-c67c-4ed2-b583-6a9a50895b122753fe<br/>
<strong>Verwendungszweck:</strong> Auch dieses Cookie speichert Ihre ID und wird für den Zahlungsprozess auf unserer Website durch Stripe verwendet.<br/>
<strong>Ablaufdatum:</strong> nach Ablauf der Sitzung</p>
        <h3 className="mb-3 mt-6 text-lg font-semibold text-gray-900">Wie lange und wo werden die Daten gespeichert?</h3>
        ...
        <h3 className="mb-3 mt-6 text-lg font-semibold text-gray-900">Rechtsgrundlage</h3>
        <p>Wir bieten also zur Abwicklung von vertraglichen bzw. rechtlichen Beziehungen (Art. 6 Abs. 1 lit. b DSGVO) neben den herkömmlichen Bank-/Kreditinstitutionen auch den Zahlungsdienstleister Stripe an. Der erfolgreiche Einsatz des Dienstes bedarf ferner Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), soweit für den Einsatz die Zulassung von Cookies notwendig ist.</p>
        ...
        <p>Mehr Informationen zu den Standardvertragsklauseln und über die Daten, die durch die Verwendung von Stripe verarbeitet werden, erfahren Sie in der Privacy Policy auf <a href="https://stripe.com/at/privacy" target="_blank" rel="noopener" className="text-blue-600 hover:underline">https://stripe.com/at/privacy</a>.</p>
