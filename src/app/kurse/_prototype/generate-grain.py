"""PROTOTYPE (#116) — generates the seamless paper-grain tile Variant A uses.

Throwaway. Run once; the output is committed to public/prototype/paper-grain.png.

    python src/app/kurse/_prototype/generate-grain.py
...
print(f"wrote public/prototype/paper-grain.png  {SIZE}x{SIZE}")
